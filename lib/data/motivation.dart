// lib/data/motivation_generator.dart
import 'dart:math';
...
class MotivationGenerator {
  ...
  final Map<String, List<String>> _adjectives = {
    'encouraging': ['stronger', 'wiser', 'better', 'brighter', 'lighter', 'calmer', 
              'clearer', 'healthier', 'happier', 'smarter', 'kinder', 'warmer',
              'braver', 'truer', 'richer'],
    'uplifting': ['awesome', 'fantastic', 'amazing', 'incredible', 'unbelievable',
                    'phenomenal', 'outstanding', 'extraordinary', 'remarkable',
                    'magnificent', 'brilliant', 'exceptional', 'stellar', 'super',
                    'mega'],
    'inspiring': ['unshakable', 'unstoppable', 'indomitable', 'formidable', 'mighty',
                'titanic', 'colossal', 'profound', 'limitless', 'boundless',
                'infinite', 'supreme', 'exceptional', 'extraordinary', 'legendary'],
    'unstoppable': ['divine', 'sacred', 'alchemical', 'quantum', 'metamorphic',
                        'transcendent', 'evolutionary', 'revolutionary', 'awakened',
                        'enlightened', 'expanded', 'liberated', 'unleashed', 
                        'unbound', 'limitless']
  };

  final Map<String, List<String>> _nouns = {
    'encouraging': ['challenge', 'setback', 'obstacle', 'difficulty', 'hurdle', 
              'problem', 'issue', 'worry', 'concern', 'doubt', 'fear',
              'mistake', 'failure', 'lesson', 'experience'],
    'uplifting': ['success', 'breakthrough', 'victory', 'achievement', 'milestone',
                    'triumph', 'accomplishment', 'win', 'peak', 'summit',
                    'highlight', 'best', 'top', 'prime', 'glory'],
    'inspiring': ['mountain', 'ocean', 'storm', 'fire', 'thunder', 'lightning',
                'sun', 'star', 'galaxy', 'universe', 'destiny', 'fate',
                'legacy', 'kingdom', 'empire'],
    'unstoppable': ['phoenix', 'butterfly', 'lotus', 'diamond', 'gold',
                        'light', 'consciousness', 'awareness', 'being', 'soul',
                        'essence', 'spirit', 'truth', 'potential', 'destiny']
  };

  final Map<String, List<String>> _verbs = {
    'encouraging': ['breathe', 'pause', 'reflect', 'rest', 'recharge', 'regroup',
              'recenter', 'rebalance', 'renew', 'refresh', 'rejuvenate',
              'replenish', 'nurture', 'heal', 'grow'],
    'uplifting': ['chase', 'pursue', 'achieve', 'accomplish', 'conquer',
                    'dominate', 'crush', 'smash', 'nail', 'rock', 'own',
                    'master', 'win', 'succeed', 'excel'],
    'inspiring': ['conquer', 'overcome', 'transcend', 'surpass', 'outshine',
                'outperform', 'outdo', 'exceed', 'eclipse', 'dwarf',
                'tower', 'rise', 'soar', 'ascend', 'dominate'],
    'unstoppable': ['awaken', 'transcend', 'evolve', 'transform', 'ascend',
